...
MyApplet.prototype = {
  ...
  _init: function(orientation, panel_height, instance_id) {
    ...
    this.autoupdate();
    this.set_applet_tooltip(_("Cpu Temperature"));
  },

  autoupdate: function () {
    let timeoutSec = 60;
    let cmdDir = "/home/mint/Drive/my_utilities/applets/";
    let cmd = cmdDir + "cpu_temp.sh -F";
    let cmd2 = cmdDir + "cpu_temp_extra.sh -F";
    ...
    this.set_applet_label( "CPU Temp:  " + appletLabelText.trimRight() );
