...
MyApplet.prototype = {
  ...
  _init: function(orientation, panel_height, instance_id) {
    ...
    this.autoupdate();
    this.set_applet_tooltip(_("Cpu Usage"));
  },

  autoupdate: function () {
    let timeoutSec = 3;
    let cmdDir = "/home/mint/Drive/my_utilities/applets/";
    let cmd = cmdDir + "read_file.sh /dev/shm/cpus_usage";
    let cmd2 = "cat <(" + cmdDir + "cpus_usage.sh) > /dev/shm/cpus_usage";
    ...
    this.set_applet_label( "CPUs:  " + appletLabelText.trimRight() );
